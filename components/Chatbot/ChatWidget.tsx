...
const ChatWidget: React.FC = () => {
    ...
    return (
        <div className="fixed bottom-24 right-6 z-[9999] flex flex-col items-end pointer-events-none">
            ...
            <button
                onClick={toggleChat}
                className={`pointer-events-auto bg-brand-dark text-white p-4 rounded-full shadow-2xl hover:scale-110 transition-transform duration-300 flex items-center justify-center border-2 border-brand-yellow ${isOpen ? 'opacity-0 scale-0 hidden' : 'opacity-100 scale-100 animate-bounce-slow'}`}
